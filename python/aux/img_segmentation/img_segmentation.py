...
class ImageSegmentation:
    def __init__(self, src_directory: str, dst_directory: str):
        ...
        for file_name in listdir(self.src_directory):
            if '.jpeg' in file_name:
                self.src_images.append(src_directory + file_name)
        
        print(self.src_images)
    ...
    def start_segmentation(self):
        ...
        while True:
            ...
            current_file_path = self.src_images[img_index]
            ...
            #spaceKey to save current mask
                ...
                cv2.imwrite(filename = 'test.png', img=self.current_mask)
                print(f'Image of index {img_index} saved to path: {self.dst_directory}')
...
img_seg = ImageSegmentation(    src_directory = './imgs_to_test/',
                                dst_directory = './')
